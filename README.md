...
* AI 랩실에 방문하여 여러가지 궁금한 점을 물어보았는데 선배가 겪은 점을 세세하게 알려줘서 고민을 해결할 수 있었다. 처음에는 가는 것이 좀 조심스러웠는데 친절하게 맞아주시고 좋은 정보도 많이 알려주셔서 좋았다.
* 많이 알지 못했던 대학원에 대해 알기 쉽게 설명해주시고 대학원의 장점을 확실히 느낄 수 있어 의미있는 시간이었다. 전보다 더 대학원 진학에 대해 관심이 생기게 되었고 학부생일 때 하면 좋은 것들도 알려주셔서 많은 정보를 얻어 갈 수 있어 좋았다.
...
<img src="https://github.com/user-attachments/assets/62cbbb00-92ce-4bdd-9912-4261383fcca5" width="300px" />


### 1. 미래기술 포스터에 대한 교수님 의견
* 포스터에서 상상한 미래를 구현하기 위해서는 어떤 기술들이 필요하고 어떤 기술들이 현재 완성되어 있는지 파악을 해야함. 그것을 바탕으로 앞으로 우리가 무엇을 할 것인지 생각을 정리하는 것이 필요.
* 너무 근미래 말고 그 이상의 미래를 상상해 보는 것이 좋아보임.

### 2. 교수님께서 과거에 상상해본 미래 기술
* 전국민이 가상의 아바타를 하나씩 만들어서 오디션을 보고 그 아바타가 방송에 나오는 시대가 될 것. 아바타가 어떤 능력을 갖도록 프로그래밍을 하는게 우리가 갖춰야할 역량이라고 생각. 

### 3. 인공지능
* 인공지능으로 요즘 할 수 있는 것들이 많은데, 어떻게 미래기술에서 인공지능을 활용할지 생각해보는 것이 좋아보임.
* 지금은 다 AI한테 밀리지만 우리가 실력을 쌓고 ai를 활용할 수 있는 사람이 되어야 함.

### 4. 교수님 연구분야
* 연구 분야는 알고리즘이고, 알고리즘이란 컴퓨터를 효율적으로 부릴 수 있게 해주는 것.
* 대표적으로 유튜브 알고리즘이 있음. 같은 선호를 가진 사람을 묶어 내가 굳이 찾아보지 않아도 그들의 성향을 예측해서 추천해주는 알고리즘이 있음.
* 포스터에서 예를 들면 주부가 AI를 활용해서 무엇을 하려고 할 때 같은 주부들한테 그런 알고리즘을 추천해줄 수 있음.

### 5. 데이터 유출에 대한 의견
* 포스터에서 가장 많이 받은 의견이 생체칩 데이터를 사용하면 민감 정보를 많이 가지고 있을텐데 그런 정보가 유출될 가능성이 있지 않을까에 대한 의견이었음. 교수님께서는 그런 데이터 유출 같은 단점은 기술이 발전하면서 항상 있어왔고, 그 단점보다 장점이 많기 때문에 기술이 발전한다고 하셨음. 그리고 장점을 발전시키면서 단점이 보완될 것이라고 하셨음. 

---

## ✏️ 느낀 점

* 상담을 들으며 미래기술을 단순한 상상이 아니라 실제 기술 기반 위에서 생각해야 한다는 점을 깨달았다. AI를 적극적으로 활용할 줄 아는 사람이 중요해질 것이라는 말이 가장 인상 깊었다. 전체적으로 미래를 바라보는 관점이 확실히 넓어진 느낌이었다.
* 처음에는 교수님과 상담을 하는 것이 부담이 되었는데, 막상 연구실에 방문을 하니 교수님께서 너무 친절하게 맞아주셔서 감사했다. 우리가 상상한 미래에 대해서 어떻게 더 구체적이고 현실적인 목표를 세울 수 있는지 말씀해주셨다. 교수님께서도 예전에 가상 아바타 기술을 상상해보신 경험이 있다고 하시며, 이 기술이 실현되기 위해 어떤 기술이 필요하고 현재까지 발전된 기술이 뭔지 파악하는 것이 우선이라고 말씀해주셨다. 앞으로 우리가 삶의 목표를 정할 때 이런 부분을 생각하면 좋을 것 같다고 생각했다.
* 우리가 만든 포스터에서 어떤 점을 더 생각해보면 좋을지 교수님 입장에서 이야기를 듣게 되어 의미 있는 시간이었다. 포스터 발표를 하면서 들었던 문제점에 대해 교수님께서 또 다른 관점으로 이야기해주셔서 생각의 폭을 넓힐 수 있었다. 교수님과의 상담이라 조금 긴장됐었는데 편안한 분위기로 상담을 할 수 있어서 좋았다.
