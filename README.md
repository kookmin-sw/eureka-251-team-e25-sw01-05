...
* 처음에는 교수님과 상담을 하는 것이 부담이 되었는데, 막상 연구실에 방문을 하니 교수님께서 너무 친절하게 맞아주셔서 감사했다. 우리가 상상한 미래에 대해서 어떻게 더 구체적이고 현실적인 목표를 세울 수 있는지 말씀해주셨다. 교수님께서도 예전에 가상 아바타 기술을 상상해보신 경험이 있다고 하시며, 이 기술이 실현되기 위해 어떤 기술이 필요하고 현재까지 발전된 기술이 뭔지 파악하는 것이 우선이라고 말씀해주셔다. 앞으로 우리가 삶의 목표를 정할 때 이런 부분을 생각하면 좋을 것 같다고 생각했다.
